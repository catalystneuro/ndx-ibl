...
subject_data = {'age': str(subject_table.get('age_weeks', '')),
                ...
                'nickname': subject_table.get('birth_date', ''),
                'url': subject_table.get('birth_date', ''),
                "responsible_user": subject_table.get('birth_date', ''),
                "death_date": subject_table.get('birth_date', ''),
                "litter": subject_table.get('birth_date', ''),
                "strain": subject_table.get('birth_date', ''),
                "source": subject_table.get('birth_date', ''),
                "line": subject_table.get('birth_date', ''),
                "projects": subject_table.get('birth_date', ''),
                "session_projects": subject_table.get('birth_date', ''),
                "lab": subject_table.get('birth_date', ''),
                "alive": subject_table.get('birth_date', False),
                "last_water_restriction": subject_table.get('birth_date', null),
                "expected_water": subject_table.get('birth_date', np.nan),
                "remaining_water": subject_table.get('birth_date', np.nan),
